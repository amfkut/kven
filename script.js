...
if (document.getElementById('map')) {
  ...
  const places = [
    ...
    { name: 'г. Комсомольск-на-Амуре', address: 'Интернациональный пр-кт, 57 (рынок Океан)', coords: [137.0098, 48.5031] },
    ...
    { name: 'г. Комсомольск-на-Амуре', address: 'Ленина пр-кт, 14А, место 59 (Металлургов)', coords: [137.0148, 48.5080] },
    ...
    { name: 'г. Комсомольск-на-Амуре', address: 'Дикопольцева, 35', coords: [137.0320, 48.5210] },
    ...
    { name: 'г. Комсомольск-на-Амуре', address: 'Пирогова, 15 (Хлебозавод)', coords: [137.0420, 48.5285] },
    ...
    { name: 'г. Комсомольск-на-Амуре', address: 'Победы пр-кт, 65', coords: [137.0560, 48.5395] },
    ...
    { name: 'г. Комсомольск-на-Амуре', address: 'Московский пр-кт, 14', coords: [137.0525, 48.5368] },
    ...
    { name: 'г. Находка', address: 'Почтовый переулок, 8', coords: [132.8640, 42.8240] },
    ...
    { name: 'г. Находка', address: 'Энтузиастов 6-р, 15 (МЖК)', coords: [132.8715, 42.8295] },
    { name: 'г. Находка', address: 'п.Ливадия, Луговая, 14 (Прага)', coords: [132.8720, 42.8300] },
    { name: 'г. Находка', address: 'Астафьева, 105А (Купеческий 2)', coords: [132.8725, 42.8305] },
    ...
    { name: 'г. Партизанск', address: 'Ленинская, 6 (Светлана)', coords: [135.0000, 45.0000] }, // ← пример, замените на реальные координаты
    { name: 'г. Находка', address: 'Спортивная, 3а', coords: [132.8760, 42.8340] },
    { name: 'г. Находка', address: 'Постышева 29', coords: [132.8679, 42.8262] },

    // Уссурийск
    { name: 'г. Уссурийск', address: 'Агеева, 52', coords: [131.9500, 43.8000] },
    { name: 'г. Уссурийск', address: 'Владивостокское шоссе, 18 (Сахпоселок)', coords: [131.9510, 43.8010] },
    { name: 'г. Уссурийск', address: 'Владивостокское шоссе, 69 (Плаза мен)', coords: [131.9520, 43.8020] },
    ...
    { name: 'г. Уссурийск', address: 'Слободская, 1Б (рынок Эдельвейс)', coords: [131.9580, 43.8080] },
    { name: 'г. Уссурийск', address: 'Советская, 96 (Новинка)', coords: [131.9590, 43.8090] },
    { name: 'г. Уссурийск', address: 'ул. Кушира, 1а', coords: [131.9600, 43.8100] },
    { name: 'г. Уссурийск', address: 'ул. Механизаторов 8а', coords: [131.9610, 43.8110] },
    ...
    // Воздвиженка
    { name: 'с. Воздвиженка', address: 'Заречная, 2', coords: [132.4000, 44.0000] },

    // Вольно-Надежденское
    { name: 'с. Вольно-Надежденское', address: 'Железнодорожная, 18', coords: [132.5000, 44.0500] },

    // Покровка
    { name: 'с. Покровка', address: 'Советов, 88 (рынок Покровка)', coords: [132.6000, 44.1000] },

    // Хабаровск
    { name: 'г. Хабаровск', address: 'Л.Толстого, 19 (рынок Центральный)', coords: [135.0000, 48.5000] },
    { name: 'г. Хабаровск', address: 'Отрадный пер-к, 3А', coords: [135.0010, 48.5010] },
    { name: 'г. Хабаровск', address: 'Суворова 49', coords: [135.0020, 48.5020] }
  ];
